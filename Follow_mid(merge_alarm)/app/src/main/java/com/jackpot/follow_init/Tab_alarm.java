    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState){
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Alarm_setting frag = new Alarm_setting();
        ...
        lv.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                db.delete(SQLiteHelper.TABLE_TASK, ide.get(position) + "=" + SQLiteHelper.KEY_ID, null);
...
//        Obj_schedule ob = (Obj_schedule)getArguments().getSerializable("runnable");
 //       Log.d("Test1231231",ob.getEvent_name() + String.valueOf(ob.getDept_latitude()));
        return rootView;
    }
}
