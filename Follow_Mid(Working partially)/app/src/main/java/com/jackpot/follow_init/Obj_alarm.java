...
public class Obj_alarm {
    ...
    public Obj_alarm(String event_name) {
        super();
        this.event_name = event_name;
    }

    public Obj_alarm(String event_name, int alarmId) {
        super();
        this.event_name = event_name;
        this.alarmId = alarmId;
    }

    public Obj_alarm(int year, int month, int day, int hour, int minute, int alarmId, String event_name) {
        this.year = year;
        this.month = month;
        this.day = day;
        this.hour = hour;
