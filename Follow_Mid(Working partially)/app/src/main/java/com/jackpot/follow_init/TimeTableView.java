...
public class TimeTableView extends LinearLayout {
    ...
    private View createClassView(final TimeTableModel model) {
        ...
        mTimeTableView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getContext(), model.getName() + "@" + model.getId(), Toast.LENGTH_LONG).show();
            }
        });
        mTimeTableView.setOnLongClickListener(new OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Toast.makeText(getContext(),model.getName() + "롱클릭됨", Toast.LENGTH_SHORT).show();
                return false;
            }
        });
