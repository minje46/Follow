...
public class Obj_search {
    ...
    public Obj_search(int pathType, int trafficType, int section_time, int section_distance, int wayCode, String busNo, int type, String startName, String endName) {
