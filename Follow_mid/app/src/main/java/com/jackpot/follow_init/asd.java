 ...
 */
public class asd extends Fragment implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
      ...
      /*
        ...
        try{
            ...
            btn_Back.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    getFragmentManager().beginTransaction().remove(asd.this).commit();
