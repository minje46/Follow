...
public class FragmentDialog extends DialogFragment {
    ...
    public interface FragmentDialogListener{
        public void onFragmentDialogClick(DialogFragment dialog, String data);
    }
    ...
    public void onAttach(Activity activity) {
        ...
        try{
            fragmentDialogListener = (FragmentDialogListener)activity;
        } catch (ClassCastException e){
            throw new ClassCastException(activity.toString()+"must implement Fragment Dialog Listener");
        }
    }
...
//                fragmentDialogListener.onFragmentDialogClick(FragmentDialogListener.this, "Some Data");
